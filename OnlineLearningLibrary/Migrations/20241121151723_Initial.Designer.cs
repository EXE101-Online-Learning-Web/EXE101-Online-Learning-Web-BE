...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.ActivityLog", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Certificate", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Course", b =>
                {
                    b.Property<int>("CourseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.CourseCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.CourseEnrollment", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.CourseTag", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.ExamTest", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Feedback", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.FinalTest", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.FinalTestQuiz", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Mooc", b =>
                {
                    b.Property<int>("MoocId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Quiz", b =>
                {
                    b.Property<int>("QuizId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.QuizAnswer", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.QuizType", b =>
                {
                    b.Property<int>("QuizTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Account", b =>
                {
                    b.HasOne("OnlineLearningLibrary.Models.Role", "Role")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.ActivityLog", b =>
                {
                    b.HasOne("OnlineLearningLibrary.Models.Account", "Account")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Course", b =>
                {
                    b.HasOne("OnlineLearningLibrary.Models.CourseCategory", "Category")
                        .WithMany("Courses")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK__Course__category__4F7CD00D");

                    b.HasOne("OnlineLearningLibrary.Models.Account", "Teacher")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.CourseEnrollment", b =>
                {
                    ...
                    b.HasOne("OnlineLearningLibrary.Models.Course", "Course")
                        .WithMany("CourseEnrollments")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.ExamTest", b =>
                {
                    b.HasOne("OnlineLearningLibrary.Models.Account", "CreatedByNavigation")
                        .WithMany("ExamTests")
                        .HasForeignKey("CreatedBy")
                        .IsRequired()
                        .HasConstraintName("FK__ExamTest__create__52593CB8");

                    b.HasOne("OnlineLearningLibrary.Models.Mooc", "Mooc")
                        .WithMany("ExamTests")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.FinalTestQuiz", b =>
                {
                    b.HasOne("OnlineLearningLibrary.Models.FinalTest", "FinalTest")
                        .WithMany("FinalTestQuizzes")
                        .HasForeignKey("FinalTestId")
                        .IsRequired()
                        .HasConstraintName("FK__FinalTest__final__571DF1D5");

                    b.HasOne("OnlineLearningLibrary.Models.Quiz", "Quiz")
                        .WithMany("FinalTestQuizzes")
            ...
            modelBuilder.Entity("OnlineLearningLibrary.Models.Quiz", b =>
                {
                    b.HasOne("OnlineLearningLibrary.Models.ExamTest", "ExamTest")
                        .WithMany("Quizzes")
                        .HasForeignKey("ExamTestId")
                        .IsRequired()
                        .HasConstraintName("FK__Quiz__examTestId__534D60F1");

                    b.HasOne("OnlineLearningLibrary.Models.QuizType", "QuizType")
                        .WithMany("Quizzes")
